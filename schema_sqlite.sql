...
INSERT OR IGNORE INTO company_profile (id, company_name, phone, email, address, gstin, logo)
...
INSERT OR IGNORE INTO role_permissions (role, permission_key, is_allowed) VALUES
...
CREATE TABLE IF NOT EXISTS customer_replacements (
    ...
    product_id INT,
    quantity INT NOT NULL,
    swap_type VARCHAR(50) DEFAULT 'replacement',
